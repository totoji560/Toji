...
let nn = 'https://example.com/example-image.jpg'; // يمكنك استبدال هذا بعنوان URL الفعلي للصورة

let handler = async (m, { conn, text, usedPrefix, command }) => {
  let fkontak = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
	text = text.endsWith('SMH') ? text.replace('SMH', '') : text 
	if (!text) throw '*[❗مساعده❗]*\n*•┃❖ابحث على اي صوره ا. شخصيه ترديها*\n*•┃❖مثال افتار نيزوكو افتار ايتاشي*'
	await conn.reply(m.chat, '*انتضر جار تحميل الافتار*', fkontak, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '𝑁𝐸𝑍𝑈𝐾𝛩–𝐵𝛩𝑇', body: `【𝑇𝐸𝑁𝐷𝛩𝑈, 𝐴𝐾𝐼𝑅𝐴】١⁵`, sourceUrl: nn,thumbnail: '' }}})
