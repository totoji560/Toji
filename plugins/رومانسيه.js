let handler = async (m, { conn, command, text, usedPrefix, participants }) => {
    if (!text) throw "*مـنـشـن الــشـخص الـذي تـريـد مـعـرفة نـسـبـة رومــنــســيــه !*"
 ...
 "100%",
    ...
    let message = `*@${mentionedUser.split("@")[0]} انــه رومنسي بـنـسـبــة ${userCharacterSeletion}*`
