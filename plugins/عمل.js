...
if (new Date - global.db.data.users[m.sender].lastwork < 600000) throw `*〄┇انت منهج استرح ${msToTime(time - new Date())} ثم عد للعمل┇➥*`
...
global.work = ["مطور مواقع ويب", "مطور العاب", "احد مطورين ميتسوري بوت 🌚", "مساعد تنسيق في ميتسوري بوت", "مساعد مشرف علي مجموعات ميتسوري", "مطور العاب", "عملت في منجم", "منظم حفلات من اجل الحصول علي",
...
"تنضم لفريق ميتسوري والحزا *ES* وتحصل علي", "لقد صممت شعار ميتسوري  *ES* وحصلت علي", 
"لقد قمت بالاشراف علي مجموعه *ES* عندما لم يكن موجود تفوز ب ", 
"لقد عمل بأفضل ما لديه في شركة طباعة كانت توظف وحصلت علي", 
"احد افراد ميتسوري  *ES*", "لقد زاد الطلب على ألعاب الأجهزة المحمولة ، لذا يمكنك إنشاء لعبة جديدة مليئة بالمعاملات الصغيرة. مع لعبتك الجديدة تكسب", 
"أنت تعمل كممثل صوتي لـسبونج بوب وتمكنت من الفوز ب ", 
"كنت تزرع وفزت ب", "تبني قلعة رملية وتربح", "لقد عملت وربحت", 
"تعمل كصانع لوجوهات لتيم ميتسوري  وتحصل علي","تعمل كبلوجر وتحصل علي", 
