let handler = async (m, { conn, command, text, usedPrefix, participants }) => {
    if (!text) throw "*مـنـشـن لــلشــخــص الـذي تـريـد مـعـرفة نـسـبـة كـــذبــه !*"
 ...
 "100%",
    ...
    let message = `*@${mentionedUser.split("@")[0]} انــه كـــاذب بـنـسـبــة ${userCharacterSeletion}*`
